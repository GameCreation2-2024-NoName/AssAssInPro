...
namespace Hmxs.Scripts
{
    public class LeftKeyboardInputHandler : InputHandler
    {
        ...
        private void Update()
        {
            _targetDirection = new Vector2(Input.GetAxis("Horizontal"), Input.GetAxis("Vertical"));
        }

        private void FixedUpdate()
        {
            if(_isGamePlay)
                _currentDirection = Vector2.Lerp(_currentDirection, _targetDirection, player.Data.keyboardRotateSpeed);
        }
    }
}